...
- ⚡ [DSA Quick Lookup](DSA/DSAQuickLookup.md) - Fast pattern recognition cheatsheet
...
### 3️⃣ [Behavioral Interview](Behavioral/)
...
- 🍕 [Food Delivery Design](SystemDesign/designs/food-delivery.md) - Swiggy/Zomato architecture
...
*Note: All figures in Lakhs Per Annum (LPA). Includes base + RSUs/ESOPs. Stock values vary. See [India-Specific.md](InterviewPrep/India-Specific.md) for detailed breakdown.*
